...
function convertTableToString(inputTable)
    ...
    for _, value in pairs(inputTable) do
        ...
        elseif typeof(value) == "table" and value and value.Name then
...
function AcrylicBlur:render(distance: number)
    ...
    local function update()
        ...
        if self._root:FindFirstChild("Mesh") then
    ...
    function self:create_tab(title: string, icon: string)
        ...
        function TabManager:create_module(settings: any)
            ...
            function ModuleManager:create_button(settings: any)
                ...
                Button.Name = "Button"
                Button.Size = UDim2.new(0, 207, 0, 17)
            ...
            function ModuleManager:create_dropdown(settings: any)
                ...
                function DropdownManager:update(option: string, skip_callback: boolean)
                    ...
                    if not skip_callback and settings.callback and typeof(settings.callback) == "function" then
                        local callbackValue
                        if settings.multi_dropdown then
                ...
                if typeof(settings.options) == "table" and #settings.options > 0 then
                    ...
                    for index, value in settings.options do
                        ...
                        Option.MouseButton1Click:Connect(function()
                            DropdownManager:update(optionText)
                        end)
                ...
                elseif settings.default then
                    DropdownManager:update(settings.default, true)
                else
                ...
                function DropdownManager:Refresh(newOptions)
                    ...
                    if typeof(newOptions) == "table" and #newOptions > 0 then
